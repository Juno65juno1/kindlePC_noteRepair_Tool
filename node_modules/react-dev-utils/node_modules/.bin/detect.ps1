...
if ($PSVersionTable.PSVersion -lt "6.0" -or $IsWindows) {
  ...
  $new_node_path="$basedir/D:/桌面/runma/Front-end/Personal_Project/kindlePC_noteRepair_Tool/node_modules/.store/detect-port-alt@1.1.6/node_modules"
}
